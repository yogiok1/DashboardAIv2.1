...
@section('title', 'Template Proposal')
@section('header-title', 'Template Proposal')
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm font-medium text-gray-900 dark:text-white">Template Proposal</span>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div class="bg-white border border-gray-200 shadow-sm dark:bg-gray-800 rounded-2xl dark:border-gray-700">
                <div class="p-6 border-b border-gray-100 dark:border-gray-700">
                    <h2 class="text-lg font-semibold text-gray-800 dark:text-white">Unggah Template Proposal</h2>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Unggah template Penilaian proposal dalam format DOCX</p>
                </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                    Contoh: "Template Penilaian 2026"
                                </p>
                            </div>
            ...
            <div class="bg-white border border-gray-200 shadow-sm dark:bg-gray-800 rounded-2xl dark:border-gray-700">
                <div class="p-6 border-b border-gray-100 dark:border-gray-700">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <h2 class="text-lg font-semibold text-gray-800 dark:text-white">Template yang Terunggah</h2>
                    ...
                    <div class="space-y-3">
                        @forelse ($extras as $extra)
                            <div class="flex items-center justify-between p-4 transition-all duration-200 border border-gray-200 rounded-lg hover:shadow-md dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                <div class="flex items-center flex-1 min-w-0 space-x-4">
                                    <div class="flex items-center justify-center flex-shrink-0 w-12 h-12 rounded-lg bg-primary-100 dark:bg-primary-900/30">
                                        <i class="text-xl fas fa-file-word text-primary-600 dark:text-primary-400"></i>
                                    </div>
                        ...
                        @empty
                            <div class="flex flex-col items-center justify-center py-12">
                                ...
                                <p class="text-gray-500 dark:text-gray-400">Unggah template pertama Anda untuk memulai.</p>
                            </div>
                        @endforelse
                    </div>
                </div>
